  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_end: 'bg-[#6523E9] text-white',
        day_selected:
          'text-slate-50 hover:bg-purple hover:text-slate-50 focus:bg-purple focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900 bg-[#6523E9]',
